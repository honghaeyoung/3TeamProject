...
<body>
<form method="post" id="pupdateform" action="/petcare/update">
<input type="hidden" name="_method" value="put">
	<table border="1">
		<tr>
			<td class="orange">제목</td>
			<td><input name="ptitle" class="ptitle" value="${dto.ptitle}"/>
			<input name="pno" class="ptitle" value="${dto.pno}" type="hidden"/></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name="paddress" value="${dto.paddress}" class="pp"></td>
		</tr>
		<tr>
			<td class="orange">연락처</td>
			<td><input name="pphone" value="${dto.pphone}" class="pp"></td>
		</tr>
		<tr>
		...
		<td class="orange">요금</td>
			<td><input name="pprice" placeholder="수정할 총 요금을 원까지 기재해주세요." class="pp"></td>
		</tr>
		<tr>
			<td class="orange">내용</td>
			<td><textarea name="pcontent" cols="40" rows="10"class="pp">${dto.pcontent}</textarea></td>
		</tr>
		<tr>
			<td colspan="2" align="center">
				<input type="submit" value="글 수정" id="btn"> <input type="reset" value="초기화" id="btn">
			</td>
		</tr>
	</table>
