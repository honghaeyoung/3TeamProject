			...
			<div
				...
				<div class="col">
					<div
						...
						<div
							...
							<h2 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">${roomlist[0].roomtitle }
							</h2>
				...
				<div class="col">
					<div
						...
						<div
							class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
							<h2 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">${roomlist[1].roomtitle }
								</h2>
							<ul class="d-flex list-unstyled mt-auto">
								<li class="me-auto"><img src="https://github.com/twbs.png"
									alt="Bootstrap" width="32" height="32"
				...
				<div class="col">
					<div
						...
						<div class="d-flex flex-column h-100 p-5 pb-3 text-shadow-1">
							<h2 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">${roomlist[2].roomtitle }
								</h2>
							<ul class="d-flex list-unstyled mt-auto">
								<li class="me-auto"><img src="https://github.com/twbs.png"
									alt="Bootstrap" width="32" height="32"
